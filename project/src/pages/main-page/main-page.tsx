...
import { MainScreenProps } from '../../types/types-page';

function MainPage({adsCount}: MainScreenProps) : JSX.Element {
  return (
      ...
      <div className="tabs">
        <section className="locations container">
          <ul className="locations__list tabs__list">
            ...
            <li className="locations__item">
              <a className="locations__item-link tabs__item" href="#brussel">
                <span>Brussels</span>
              </a>
            </li>
            <li className="locations__item">
        ...
        <div className="cities__places-container container">
          <section className="cities__places places">
            ...
            <div className="cities__places-list places__list tabs__content">
              {[...Array(adsCount).keys()].map((item) => <PlaceCard key={item} />)}
            </div>
          </section>
